...
const COMMUNITIES: { id: Community; label: string; flag: string; greeting: string; greetingAm: string }[] = [
  { id: "ethiopian", label: "אתיופי", flag: "🇪🇹", greeting: "ברוך הבא! נשמח להכיר אותך.", greetingAm: "እንኳን ደህና መጡ!" },
  { id: "russian", label: "רוסי", flag: "🇷🇺", greeting: "ברוך הבא! ספר לנו על עצמך.", greetingAm: "Добро пожаловать!" },
  { id: "manashe", label: "שבט המנשה", flag: "✡️", greeting: "ברוכים הבאים לישראל ולמסע המקצועי.", greetingAm: "ברוכים הבאים." },
];
...
const CORE: Question[] = [
  ...
  { id: "q9", category: "support", he: "מה השכר שאתה מצפה בסוף?", am: "ምን ያህል ደመወዝ ትጠብቃለህ?", options: [
